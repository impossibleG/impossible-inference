...
$notice.Add("")
$notice.Add("Impossible Inference is distributed under MIT OR Apache-2.0. The inventory below records each dependency's declared license; complete mapped texts are in ``THIRD_PARTY_LICENSES.txt``. ``cargo deny`` validates the graph against ``deny.toml``.")
$notice.Add("")
