...
| `arbitrary` | 1.4.2 | `MIT OR Apache-2.0` | crates.io |
| `async-trait` | 0.1.92 | `MIT OR Apache-2.0` | crates.io |
| `atomic-waker` | 1.1.2 | `Apache-2.0 OR MIT` | crates.io |
| `axum` | 0.8.6 | `MIT` | crates.io |
...
| `cc` | 1.4.6 | `MIT OR Apache-2.0` | crates.io |
| `cfg_aliases` | 0.2.2 | `MIT` | crates.io |
| `cfg-if` | 1.0.5 | `MIT OR Apache-2.0` | crates.io |
| `chacha20` | 0.10.2 | `MIT OR Apache-2.0` | crates.io |
| `clap` | 4.5.50 | `MIT OR Apache-2.0` | crates.io |
| `clap_builder` | 4.5.50 | `MIT OR Apache-2.0` | crates.io |
| `clap_derive` | 4.5.49 | `MIT OR Apache-2.0` | crates.io |
| `clap_lex` | 0.7.7 | `MIT OR Apache-2.0` | crates.io |
...
| `derive_arbitrary` | 1.4.2 | `MIT OR Apache-2.0` | crates.io |
...
| `impossible-server-core` | 0.1.0 | `MIT OR Apache-2.0` | other |
| `impossible-server-testkit` | 0.1.0 | `MIT OR Apache-2.0` | other |
| `indexmap` | 2.14.2 | `Apache-2.0 OR MIT` | crates.io |
| `ipnet` | 2.12.2 | `MIT OR Apache-2.0` | crates.io |
...
| `js-sys` | 0.3.105 | `MIT OR Apache-2.0` | crates.io |
...
| `lru-slab` | 0.1.3 | `MIT OR Apache-2.0 OR Zlib` | crates.io |
...
| `protoc-bin-vendored` | 3.2.0 | `MIT` | crates.io |
| `protoc-bin-vendored-linux-aarch_64` | 3.2.0 | `MIT` | crates.io |
| `protoc-bin-vendored-linux-ppcle_64` | 3.2.0 | `MIT` | crates.io |
| `protoc-bin-vendored-linux-s390_64` | 3.2.0 | `MIT` | crates.io |
| `protoc-bin-vendored-linux-x86_32` | 3.2.0 | `MIT` | crates.io |
| `protoc-bin-vendored-linux-x86_64` | 3.2.0 | `MIT` | crates.io |
| `protoc-bin-vendored-macos-aarch_64` | 3.2.0 | `MIT` | crates.io |
| `protoc-bin-vendored-macos-x86_64` | 3.2.0 | `MIT` | crates.io |
| `protoc-bin-vendored-win32` | 3.2.0 | `MIT` | crates.io |
| `pulldown-cmark` | 0.13.4 | `MIT` | crates.io |
| `pulldown-cmark-to-cmark` | 22.0.1 | `Apache-2.0` | crates.io |
| `quinn` | 0.11.12 | `MIT OR Apache-2.0` | crates.io |
| `quinn-proto` | 0.11.18 | `MIT OR Apache-2.0` | crates.io |
...
| `reqwest` | 0.12.24 | `MIT OR Apache-2.0` | crates.io |
...
| `serde_json` | 1.0.145 | `MIT OR Apache-2.0` | crates.io |
...
| `smallvec` | 1.16.1 | `MIT OR Apache-2.0` | crates.io |
...
| `tokio` | 1.48.0 | `MIT` | crates.io |
| `tokio-macros` | 2.6.1 | `MIT` | crates.io |
| `tokio-rustls` | 0.26.5 | `MIT OR Apache-2.0` | crates.io |
| `tokio-stream` | 0.1.17 | `MIT` | crates.io |
| `tokio-tungstenite` | 0.28.0 | `MIT` | crates.io |
| `tokio-util` | 0.7.19 | `MIT` | crates.io |
| `tonic` | 0.14.6 | `MIT` | crates.io |
| `tonic-build` | 0.14.6 | `MIT` | crates.io |
| `tonic-health` | 0.14.6 | `MIT` | crates.io |
| `tonic-prost` | 0.14.6 | `MIT` | crates.io |
| `tonic-prost-build` | 0.14.6 | `MIT` | crates.io |
| `tonic-reflection` | 0.14.6 | `MIT` | crates.io |
| `tower` | 0.5.2 | `MIT` | crates.io |
...
| `wasm-bindgen` | 0.2.128 | `MIT OR Apache-2.0` | crates.io |
| `wasm-bindgen-futures` | 0.4.78 | `MIT OR Apache-2.0` | crates.io |
| `wasm-bindgen-macro` | 0.2.128 | `MIT OR Apache-2.0` | crates.io |
| `wasm-bindgen-macro-support` | 0.2.128 | `MIT OR Apache-2.0` | crates.io |
| `wasm-bindgen-shared` | 0.2.128 | `MIT OR Apache-2.0` | crates.io |
| `wasm-streams` | 0.4.2 | `MIT OR Apache-2.0` | crates.io |
| `web-sys` | 0.3.105 | `MIT OR Apache-2.0` | crates.io |
...
| `yoke-derive` | 0.8.3 | `Unicode-3.0` | crates.io |
| `zerocopy` | 0.8.57 | `BSD-2-Clause OR Apache-2.0 OR MIT` | crates.io |
| `zerocopy-derive` | 0.8.57 | `BSD-2-Clause OR Apache-2.0 OR MIT` | crates.io |
| `zerofrom` | 0.1.8 | `Unicode-3.0` | crates.io |
| `zerofrom-derive` | 0.1.8 | `Unicode-3.0` | crates.io |
...
| `zip` | 6.0.0 | `MIT` | crates.io |
| `zlib-rs` | 0.6.8 | `Zlib` | crates.io |
